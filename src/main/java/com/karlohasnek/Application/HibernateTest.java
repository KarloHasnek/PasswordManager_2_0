...
//                .uniqueResult();
        ...
        PasswordEntry passwordEntry1 = new PasswordEntry("facebook.com", "testuser", "password123", user);
        PasswordEntry passwordEntry2 = new PasswordEntry("gmail.com", "testuser", "password123", user);
